...
decoder_model_path = '/home/ysnamgoong42/ws/BANKWAREGLOBAL/#WORKSPACE/3_2023-10-26_CodeBase/saved_models/Salesforce/codet5p-220m/checkpoint-best-ppl/pytorch_model.bin'
...
model.load_state_dict(torch.load(decoder_model_path))
